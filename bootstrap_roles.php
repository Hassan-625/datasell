...
try{
 ...
 $adds=['admin_role'=>"ALTER TABLE users ADD admin_role VARCHAR(20) NOT NULL DEFAULT 'none' AFTER is_admin",'customer_tier'=>"ALTER TABLE users ADD customer_tier VARCHAR(20) NOT NULL DEFAULT 'standard' AFTER account_type",'tier_updated_at'=>"ALTER TABLE users ADD tier_updated_at DATETIME NULL AFTER customer_tier",'staff_role'=>"ALTER TABLE users ADD staff_role VARCHAR(40) NULL AFTER admin_role",'admin_permissions'=>"ALTER TABLE users ADD admin_permissions TEXT NULL AFTER staff_role",'admin_enabled'=>"ALTER TABLE users ADD admin_enabled TINYINT(1) NOT NULL DEFAULT 1 AFTER admin_permissions"];
